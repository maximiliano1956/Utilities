...
#define MAXSOL	10000			// Numero massimo elementi in ogni tipologia di gruppo
...
int main(char argc,char *argv[]) {
	...
	n=2;		// Dimensioni della matrice
	k=7;		// Numero simboli nel campo (deve essere un numero primo >= 2)
